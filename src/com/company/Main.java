...
public class Main {
    ...
    public static int[] heroesHealth = {250, 250, 250, 280};
    public static int[] heroesDamage = {20, 15, 10, 0};
    public  static int medikHelp = 20;
    public static String[] heroesAttackType = {"Physical",
            "Magical", "Kinetic","Medik"};
    ...
    public static void setMedikHelp() { // Dom Zadanie nomer 4
        Random r = new Random();
        int randomIndex = r.nextInt(medikHelp);
        for (int i = 0; i < heroesHealth.length; i++) {
            heroesHealth[i]=heroesHealth[i]+randomIndex;
            System.out.println(medikHelp);
        }
    }
